 ...
 *
 */
public abstract class SimulationEvent extends Event implements Comparable<SimulationEvent> {
   ...
   */
  public SimulationEvent(Id locationId, EventTypeEnum type, int simDay, int simHour)
  {
