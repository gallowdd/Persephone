...
public class AgentToLocationInitializer {
  ...
  {
   final String country = xmlSyntheticEnvironment.getCountry().value();
   final String version = xmlSyntheticEnvironment.getVersion().value();
   final String identifier = xmlSyntheticEnvironment.getIdentifier();
  }
