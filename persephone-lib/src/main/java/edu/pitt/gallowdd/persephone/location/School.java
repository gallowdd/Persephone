...
public class School extends GenericLocation {
   ...
   * @throws IdException if the id is invalid
   */
  protected School(String idString, double latitude, double longitude, GenericIdMixingContainer mixingContainer) throws IdException
  {
   ...
   * @throws IdException if the id is invalid
   */
  protected School(String idString, double latitude, double longitude, double elevation, GenericIdMixingContainer mixingContainer) throws IdException
  {
  ...
  public void onSubscribe(@NonNull Disposable d)
  {
    ...
    System.out.println("onSubscribe in School " + this.getId()); 
  }
  ...
  {
    // TODO Auto-generated method stub
    if(t.getLocationId().equals(this.getId()))
    {
      switch(t.getType())
      {
        case LOCATION_CLOSE_EVENT:
          break;
        case LOCATION_OPEN_EVENT:
          break;
        case LOCATION_START_MIXING_EVENT:
          break;
        default:
          break;
